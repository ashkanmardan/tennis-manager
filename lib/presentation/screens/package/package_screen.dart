  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('زمان کلاس شما', style: TextStyle(color: Colors.white)),
      ),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text('ساخت کلاس جدید', style: TextStyle(color: Colors.white)),
  ...
  Widget build(BuildContext context) => Center(
    child: Padding(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const SizedBox(height: 8),
        const Text('با دکمه زیر اولین کلاس را اضافه کنید',
...
class _AddPackageSheetState extends State<_AddPackageSheet> {
  final _nameCtrl  = TextEditingController(text: 'کلاس تنیس');
  ...
  Future<void> _save() async {
    ...
    try {
      await widget.repo.addPackage(TrainingPackage(
        name: _nameCtrl.text.trim().isEmpty ? 'کلاس تنیس' : _nameCtrl.text.trim(),
  ...
  Widget build(BuildContext context) => Container(
    ...
    child: SingleChildScrollView(
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        const Text('ساخت کلاس جدید', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
        const SizedBox(height: 20),
        _field(_nameCtrl, 'نام کلاس', Icons.label_outline),
        ...
        SizedBox(
          ...
          child: FilledButton(
            ...
            child: _saving
                ...
                : const Text('ذخیره کلاس', style: TextStyle(fontSize: 16)),
          ),
        ),
      ]),
    ),
