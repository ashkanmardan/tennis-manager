                ...
                child: Padding(
                  ...
                  child: Column(children: [
                    Container(
                      ...
                      child: const Column(children: [
                        Text('این برنامه یک دستیار شخصی برای بازیکنان تنیس است تا کلاس‌ها، پرداخت‌ها و هزینه‌های جانبی را ساده و منظم مدیریت کنند.',
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
                          ...
                          SizedBox(width: 4),
                          Text('0918•••3897', style: TextStyle(color: Colors.white60, fontSize: 11)),
                        ]),
                        SizedBox(height: 4),
                        Row(mainAxisAlignment: MainAxisAlignment.center, children: [
