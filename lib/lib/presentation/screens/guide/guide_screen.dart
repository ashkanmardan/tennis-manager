      ...
      body: ListView(
        ...
        children: const [
          _GuideCard(
            ...
            steps: [
              '📅 تاریخ امروز و احوال‌پرسی بالای صفحه',
              '📊 نوار آمار: جلسه ماه، پیشرفت پکیج و بدهی',
              '🎾 کارت «امروز کلاس داری» — فقط وقتی جلسه امروز دارید',
          ...
          _GuideCard(
            ...
            steps: [
              ...
              '🔄 جلسه جبرانی با برچسب جداگانه نمایش داده می‌شه',
            ],
          ),
          SizedBox(height: 14),
          _GuideCard(
          ...
          _GuideCard(
            ...
            steps: [
              ...
              '☎️ روی تلفن مربی بزنید تا مستقیم زنگ بزنید',
              '📸 روی اینستاگرام بزنید تا اپ باز شود',
              '💳 روی شماره کارت بزنید تا کپی شود',
              'دکمه ✏️ بالا برای ویرایش اطلاعات',
            ],
          ),
          SizedBox(height: 14),
          _GuideCard(
